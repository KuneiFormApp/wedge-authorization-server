...
3. **Client configured** in [application.yaml](file:///G:/JavaProjects/_kuneiform/wedge-authorization-server/infraestructure/src/main/resources/application.yaml):
   ```yaml
   wedge:
     clients:
...
The browser will show an error (because nothing is running on port 3000), but **copy the [code](file:///g:/JavaProjects/_kuneiform/wedge-authorization-server/infraestructure/src/main/java/com/kuneiform/infraestructure/config/SecurityConfig.java#117-122) parameter from the URL**.
...
|-----------|----------|-------------|
| `response_type` | ✅ | Must be [code](file:///g:/JavaProjects/_kuneiform/wedge-authorization-server/infraestructure/src/main/java/com/kuneiform/infraestructure/config/SecurityConfig.java#117-122) |
...
| [code](file:///g:/JavaProjects/_kuneiform/wedge-authorization-server/infraestructure/src/main/java/com/kuneiform/infraestructure/config/SecurityConfig.java#117-122) | ✅ | Authorization code from step 1 |
...
See [test-pkce-flow.sh](file:///C:/Users/frank/.gemini/antigravity/brain/75c7dd94-5a54-406b-9df4-ebe7a66e2161/test-pkce-flow.sh) for a complete automated test script.
