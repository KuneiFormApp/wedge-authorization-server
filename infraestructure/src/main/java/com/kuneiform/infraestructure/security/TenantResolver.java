...
public class TenantResolver {
  ...
  /**
   * Resolve the tenant ID from the current HTTP request.
   *
   * @param request The HTTP request
   * @return The tenant ID, or default tenant if multi-tenancy is disabled or path doesn't match
   */
  ...
  /**
   * Check if a request path contains a tenant identifier.
   *
   * @param request The HTTP request
   * @return true if path contains tenant ID
   */
