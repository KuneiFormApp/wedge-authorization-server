...
public class UserProviderRestClient {
   ...
   *
   * @param endpoint the user provider endpoint
   * @param username the username to find
   * @return UserResponse if found, empty otherwise
   */
   ...
   * @return UserResponse if valid, empty otherwise
   */
   ...
   * @param mfaSecret the TOTP secret
