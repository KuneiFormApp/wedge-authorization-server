...
public final class TotpAlgorithm {
   ...
   *
   * @param secretKey the secret key bytes
   * @param timeStep the time step (current time in seconds / 30)
   * @return the 6-digit OTP
   * @throws GeneralSecurityException if HMAC-SHA1 is not available
   */
  ...
  /**
   * Converts a long value to an 8-byte array (big-endian).
   *
  ...
  /**
   * Performs HMAC-SHA1 on the given data with the provided key.
   *
